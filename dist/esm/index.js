...
var require_HED8_0_0 = __commonJS({
  'data/HED8.0.0.xml'(exports, module) {
    module.exports = './HED8.0.0-FV4I2QEK.xml'
  },
})

// data/HED_testlib_1.0.2.xml
var require_HED_testlib_1_0_2 = __commonJS({
  'data/HED_testlib_1.0.2.xml'(exports, module) {
    module.exports = './HED_testlib_1.0.2-WZ7RGY7F.xml'
  },
})
...
var require_config = __commonJS({
  'common/schema/config.js'(exports, module) {
    init_define_process()
    var localSchemaList = /* @__PURE__ */ new Map([
...
var require_util = __commonJS({
  'node_modules/util/util.js'(exports) {
    ...
    exports.debuglog = function (set) {
      if (isUndefined(debugEnviron)) debugEnviron = define_process_default.env.NODE_DEBUG || ''
      set = set.toUpperCase()
      if (!debugs[set]) {
  ...
  'node_modules/path/path.js'(exports, module) {
    ...
    win32.resolve = function () {
      ...
      for (var i = arguments.length - 1; i >= -1; i--) {
        ...
        if (i >= 0) {
          ...
          path = define_process_default.cwd()
        } else {
          path = define_process_default.env['=' + resolvedDevice]
    ...
    posix.resolve = function () {
      ...
      for (var i = arguments.length - 1; i >= -1 && !resolvedAbsolute; i--) {
        var path = i >= 0 ? arguments[i] : define_process_default.cwd()
        if (!util.isString(path)) {
          throw new TypeError('Arguments to path.resolve must be strings')
        } else if (!path) {
          continue
...
var require_loader = __commonJS({
  'common/schema/loader.js'(exports, module) {
    ...
    var loadLocalSchema = function (path2) {
      return loadSchemaFile(files.readFile(path2), 'localSchemaLoadFailed', { path: path2 })
    }
...
var require_hed_javascript = __commonJS({
  'index.js'(exports, module) {
    ...
    var path = require_path()
    var fallbackDirectoryBase = path.resolve('data')
    module.exports = {
