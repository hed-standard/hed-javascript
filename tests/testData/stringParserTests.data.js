...
export const parseTestData = [
  ...
  },
  {
    ...
    description: 'Definition and def-expand requirements',
    tests: [
      {
      ...
      },
      {
        ...
        errors: [
          generateIssue('invalidDefinitionForbidden', {
            tagGroup: '(Definition/DefNested, (Def/Nested, (Red, Blue, (Def/Blech)), Triangle))',
            tag: 'Definition/DefNested',
          }),
        ],
        warnings: [],
      },
      {
        ...
        errors: [
          generateIssue('invalidDefinitionForbidden', {
            tagGroup: '(Definition/NestedDefinition, (Touchscreen, (Definition/InnerDefinition, (Square))))',
            tag: 'Definition/NestedDefinition',
          }),
        ],
        warnings: [],
      },
      ...
      },
      {
        ...
        errors: [
          generateIssue('invalidDefinitionGroupStructure', {
            tagGroup: '(Def-expand/Acc/5.4, (Acceleration/5.4 m-per-s^2, Red), Blue)',
            tag: 'Def-expand/Acc/5.4',
          }),
        ],
        warnings: [],
      },
      ...
      },
      {
        ...
        errors: [
          generateIssue('invalidDefinitionForbidden', {
            tag: 'Def-expand/Blech',
            tagGroup: '(Def-expand/Blech, (Agent-action, (Def-expand/Temp), Item))',
          }),
        ],
        warnings: [],
      },
  ...
  },
  {
    ...
    tests: [
      ...
      },
      {
        ...
        placeholdersAllowed: false,
        definitionsAllowed: false,
        errors: [generateIssue('invalidNumberOfSubgroups', { string: '(Duration/10)', tag: 'Duration/10' })],
        warnings: [],
      },
      {
        ...
        definitionsAllowed: false,
        errors: [
          generateIssue('invalidNumberOfSubgroups', { string: '(Duration/10, ({event_code}))', tag: 'Duration/10' }),
        ],
        warnings: [],
      },
      {
      ...
      },
      {
        ...
        stringShort: '(Delay/5, Duration/10, (Event, {event_code}))',
        placeholdersAllowed: false,
        definitionsAllowed: false,
        errors: [],
        warnings: [],
      },
      {
        ...
        placeholdersAllowed: false,
        definitionsAllowed: false,
        errors: [generateIssue('tooManyGroupTopTags', { string: '(Delay/5, (Def-expand/MyColor, (Label/Pie)))' })],
        warnings: [],
      },
      {
        testname: 'delay-duration-same-group',
      ...
      },
      {
        ...
        stringShort: '((Def-expand/MyColor, (Label/Pie)), Onset)',
        placeholdersAllowed: false,
        definitionsAllowed: false,
        errors: [],
        warnings: [],
      ...
      },
      {
        ...
        errors: [
          generateIssue('invalidDefinitionForbidden', {
            tagGroup: '(Def-expand/myDef, (Item,(Def/Temp)))',
            tag: 'Def-expand/myDef',
          }),
        ],
        warnings: [],
      },
